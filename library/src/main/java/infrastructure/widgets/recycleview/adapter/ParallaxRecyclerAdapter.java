package infrastructure.widgets.recycleview.adapter;
 ...
 */
public abstract class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView
        .ViewHolder> {
    ...
    public abstract void onBindViewHolderImpl(RecyclerView.ViewHolder viewHolder,
        ...
        if (mOnClickEvent != null) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnClickEvent.onClick(v, holder.getAdapterPosition() - (mHeader == null ? 0 :
                            1));
                }
            });
        }
...
/*
    private void createAdapter(RecyclerView recyclerView) {
        ...
        final ParallaxRecyclerAdapter<String> adapter = new ParallaxRecyclerAdapter<String>
        (content) {
            @Override
            public void onBindViewHolderImpl(RecyclerView.ViewHolder viewHolder,
            ParallaxRecyclerAdapter<String> adapter, int i) {
            ...
            ParallaxRecyclerAdapter<String> adapter, int i) {
                return new ViewHolder(getLayoutInflater().inflate(R.layout.row_recyclerview,
                viewGroup, false));
            }
        ...
        adapter.setOnClickEvent(new ParallaxRecyclerAdapter.OnClickEvent() {
            ...
            public void onClick(View v, int position) {
                Toast.makeText(PersonalInfoActivity.this, "You clicked '" + position + "'", Toast
                .LENGTH_SHORT).show();
            }
        });
