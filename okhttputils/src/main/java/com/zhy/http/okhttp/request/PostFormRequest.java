...
public class PostFormRequest extends OkHttpRequest {
    ...
    public PostFormRequest(String url, Object tag, Map<String, String> params, Map<String,
            String> headers, List<PostFormBuilder.FileInput> files, int id) {
    ...
    protected RequestBody buildRequestBody() {
        if (files == null || files.isEmpty()) {
            ...
            for (int i = 0; i < files.size(); i++) {
                ...
                RequestBody fileBody = RequestBody.create(MediaType.parse(guessMimeType(fileInput
